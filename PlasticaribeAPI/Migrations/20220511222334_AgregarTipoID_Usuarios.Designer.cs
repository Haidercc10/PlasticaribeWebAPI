...
namespace PlasticaribeAPI.Migrations
{
    ...
    [Migration("20220511222334_AgregarTipoID_Usuarios")]
    partial class AgregarTipoID_Usuarios
    {
            ...
            modelBuilder.Entity("PlasticaribeAPI.Models.Usuario", b =>
                {
                    ...
                    b.Property<long>("cajComp_Id1")
                        .HasColumnType("bigint");

                    b.Property<long>("eps_Id")
                        .HasColumnType("bigint");

                    b.Property<long>("eps_Id1")
                        .HasColumnType("bigint");

                    b.Property<long>("fPen_Id")
                        .HasColumnType("bigint");

                    b.Property<long>("fPen_Id1")
                        .HasColumnType("bigint");

                    b.Property<int>("tpUsu_Id")
                        .HasColumnType("int");

                    b.Property<int>("tpUsu_Id1")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("Empresa_Id1");

                    b.HasIndex("Estado_Id1");

                    b.HasIndex("RolUsu_Id1");

                    b.HasIndex("TipoIdentificacion_Id");

                    b.HasIndex("cajComp_Id1");

                    b.HasIndex("eps_Id1");

                    b.HasIndex("fPen_Id1");

                    b.HasIndex("tpUsu_Id1");
