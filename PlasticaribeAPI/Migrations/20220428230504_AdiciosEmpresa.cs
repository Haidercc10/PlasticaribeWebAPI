...
{
    public partial class AdiciosEmpresa : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TipoIdentificacion_Id1 = table.Column<string>(type: "varchar(10)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Empresas_TipoIdentificaciones_TipoIdentificacion_Id1",
                        column: x => x.TipoIdentificacion_Id1,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Empresas_TipoIdentificacion_Id1",
                table: "Empresas",
                column: "TipoIdentificacion_Id1");
        }
