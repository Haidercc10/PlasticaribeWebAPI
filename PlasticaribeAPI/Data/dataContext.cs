...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member
    public class dataContext : DbContext
    {
        ...
        public DbSet<Ubicaciones_BodegaRollos> Ubicaciones_BodegaRollos { get; set; }
        ...
        public DbSet<Asignacion_RollosOT> Asignacion_RollosOT { get; set; }
        public DbSet<Detalles_AsignacionRollosOT> Detalles_AsignacionRollosOT { get; set; }

        //public DbSet<Tipos_Servicios> Tipos_Servicios { get; set; }

        public DbSet<Servicios_Produccion> Servicios_Produccion { get; set; }
        ...
        public DbSet<Planillas_Despacho> Planillas_Despacho { get; set; }

        public DbSet<Detalles_PlanillaDespacho> Detalles_PlanillaDespacho { get; set; }
        public DbSet<Trazabilidad_Produccion> Trazabilidad_Produccion { get; set; }
        ...
        public DbSet<Toma_Fisica_Inventario> Toma_Fisica_Inventario { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Devolucion_ProductoFacturado>().HasOne(x => x.Reposicion).WithMany().HasForeignKey(x => x.Reposicion_Id).OnDelete(deleteBehavior: DeleteBehavior.Restrict);
            //Ordenar campos en la tabla. 
            modelBuilder.Entity<Devolucion_ProductoFacturado>(entity =>
            {
                entity.Property(e => e.DevProdFact_Id).HasColumnOrder(0);
                entity.Property(e => e.Id_OrdenFact).HasColumnOrder(1);
                entity.Property(e => e.FacturaVta_Id).HasColumnOrder(2);
                entity.Property(e => e.DevProdFact_Reposicion).HasColumnOrder(3);
                entity.Property(e => e.DevProdFact_NotaCredito).HasColumnOrder(4);
                entity.Property(e => e.Cli_Id).HasColumnOrder(5);
                entity.Property(e => e.DevProdFact_Responsable).HasColumnOrder(6);
                entity.Property(e => e.Asesor_Id).HasColumnOrder(7);
                entity.Property(e => e.Estado_Id).HasColumnOrder(8);
                entity.Property(e => e.Usua_Id).HasColumnOrder(9);
                entity.Property(e => e.DevProdFact_Fecha).HasColumnOrder(10);
                entity.Property(e => e.DevProdFact_Hora).HasColumnOrder(11);
                entity.Property(e => e.DevProdFact_Observacion).HasColumnOrder(12);
                entity.Property(e => e.UsuaModifica_Id).HasColumnOrder(13);
                entity.Property(e => e.DevProdFact_FechaModificado).HasColumnOrder(14);
                entity.Property(e => e.DevProdFact_HoraModificado).HasColumnOrder(15);
                entity.Property(e => e.DevProdFact_ObservacionModificado).HasColumnOrder(16);
                entity.Property(e => e.UsuaGestiona_Id).HasColumnOrder(17);
                entity.Property(e => e.DevProdFact_FechaGestion).HasColumnOrder(18);
                entity.Property(e => e.DevProdFact_HoraGestion).HasColumnOrder(19);
                entity.Property(e => e.DevProdFact_ObservacionGestion).HasColumnOrder(20);
                entity.Property(e => e.UsuaFinaliza_Id).HasColumnOrder(21);
                entity.Property(e => e.DevProdFact_FechaFinalizado).HasColumnOrder(22);
                entity.Property(e => e.DevProdFact_HoraFinalizado).HasColumnOrder(23);
                entity.Property(e => e.DevProdFact_ObservacionFinal).HasColumnOrder(24);
                entity.Property(e => e.TipoDevProdFact_Id).HasColumnOrder(25);
                //entity.Property(e => e.Rep_Id).HasColumnOrder(26);
            });
            ...
            modelBuilder.Entity<DetalleDevolucion_ProductoFacturado>().HasOne(x => x.Orden_Fact).WithMany().HasForeignKey(z => z.Of_Id).OnDelete(deleteBehavior: DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity<Detalles_SolicitudRollos>().HasOne(x => x.Fallas).WithMany().HasForeignKey(y => y.Falla_Id).OnDelete(deleteBehavior: DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity<Detalles_BodegasRollos>().HasOne(x => x.Bodega_Ingreso).WithMany().HasForeignKey(y => y.BgRollo_BodegaIngreso).OnDelete(deleteBehavior: DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity<Certificados_Calidad>().ToTable(x => x.HasTrigger("TR_UpdateQualityCertificates"));
            ...
            modelBuilder.Entity<Produccion_Procesos>().HasOne(x => x.Autoriza).WithMany().HasForeignKey(y => y.Autoriza_Id).OnDelete(deleteBehavior: DeleteBehavior.Restrict);
            modelBuilder.Entity<Produccion_Procesos>().HasOne(x => x.Supervisor).WithMany().HasForeignKey(y => y.Supervisor_Id).OnDelete(deleteBehavior: DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity<OrdenFacturacion>().HasOne(x => x.Asesor_Comercial).WithMany().HasForeignKey(y => y.Asesor_Id).OnDelete(deleteBehavior: DeleteBehavior.Restrict);
            ...
            //Incapacidades
            modelBuilder.Entity<Incapacidades>().ToTable(tb => tb.HasTrigger("Auditoria_Incapacidades"));
            ...
            //Salidas_Peletizado
            modelBuilder.Entity<Salidas_Peletizado>().HasOne(x => x.MatPrima).WithMany().HasForeignKey(x => x.MatPri_Id).OnDelete(deleteBehavior: DeleteBehavior.Restrict);
            modelBuilder.Entity<Salidas_Peletizado>().HasOne(x => x.Usuario).WithMany().HasForeignKey(x => x.Usua_Id).OnDelete(deleteBehavior: DeleteBehavior.Restrict);
            modelBuilder.Entity<Salidas_Peletizado>().HasOne(x => x.Estados).WithMany().HasForeignKey(x => x.Estado_Id).OnDelete(deleteBehavior: DeleteBehavior.Restrict);
            modelBuilder.Entity<Salidas_Peletizado>().HasOne(x => x.Usuario2).WithMany().HasForeignKey(x => x.Usua_Aprueba).OnDelete(deleteBehavior: DeleteBehavior.Restrict);
            modelBuilder.Entity<Salidas_Peletizado>().HasOne(x => x.Und).WithMany().HasForeignKey(x => x.UndMed_Id).OnDelete(deleteBehavior: DeleteBehavior.Restrict);

            //Detalles Salidas Peletizado 
            modelBuilder.Entity<Detalles_SalidasPeletizado>().HasOne(x => x.Salidas_Pele).WithMany().HasForeignKey(x => x.SalPel_Id).OnDelete(deleteBehavior: DeleteBehavior.Restrict);
            ...
            //Ubicaciones bodega rollos
            modelBuilder.Entity<Ubicaciones_BodegaRollos>().HasOne(x => x.Procesos).WithMany().HasForeignKey(x => x.Proceso_Id).OnDelete(deleteBehavior: DeleteBehavior.Restrict);

            //Asignacion Rollos OT
            modelBuilder.Entity<Asignacion_RollosOT>().HasOne(x => x.Usuario).WithMany().HasForeignKey(x => x.Usua_Id).OnDelete(deleteBehavior: DeleteBehavior.Restrict);

            //Asignacion Rollos OT
            modelBuilder.Entity<Detalles_AsignacionRollosOT>().HasOne(x => x.Producto).WithMany().HasForeignKey(x => x.Prod_Id).OnDelete(deleteBehavior: DeleteBehavior.Restrict);
            modelBuilder.Entity<Detalles_AsignacionRollosOT>().HasOne(x => x.AsgRollosOT).WithMany().HasForeignKey(x => x.AsgRll_Id).OnDelete(deleteBehavior: DeleteBehavior.Restrict);
            modelBuilder.Entity<Detalles_AsignacionRollosOT>().HasOne(x => x.Proceso).WithMany().HasForeignKey(x => x.Proceso_Id).OnDelete(deleteBehavior: DeleteBehavior.Restrict);
            modelBuilder.Entity<Detalles_AsignacionRollosOT>().HasOne(x => x.Unidad_Medida).WithMany().HasForeignKey(x => x.UndMed_Id).OnDelete(deleteBehavior: DeleteBehavior.Restrict);

            //Tipos Servicios
            //modelBuilder.Entity<Tipos_Servicios>().HasOne(x => x.Areas).WithMany().HasForeignKey(x => x.Area_Id).OnDelete(deleteBehavior: DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity<Maquilas_Internas>().HasOne(x => x.Cono).WithMany().HasForeignKey(x => x.Cono_Id).OnDelete(deleteBehavior: DeleteBehavior.Restrict);
            modelBuilder.Entity<Maquilas_Internas>().HasOne(x => x.UndMedida).WithMany().HasForeignKey(x => x.Presentacion).OnDelete(deleteBehavior: DeleteBehavior.Restrict);
            modelBuilder.Entity<Maquilas_Internas>().HasOne(x => x.Operario).WithMany().HasForeignKey(x => x.Operario_Id).OnDelete(deleteBehavior: DeleteBehavior.Restrict);
            modelBuilder.Entity<Maquilas_Internas>().HasOne(x => x.Procesos).WithMany().HasForeignKey(x => x.Proceso_Id).OnDelete(deleteBehavior: DeleteBehavior.Restrict);
            ...
            //Planillas Despacho
            modelBuilder.Entity<Planillas_Despacho>().HasOne(x => x.Conductor).WithMany().HasForeignKey(x => x.Usua_Conductor).OnDelete(deleteBehavior: DeleteBehavior.Restrict);
            modelBuilder.Entity<Planillas_Despacho>().HasOne(x => x.Usuario).WithMany().HasForeignKey(x => x.Usua_Id).OnDelete(deleteBehavior: DeleteBehavior.Restrict);
            modelBuilder.Entity<Planillas_Despacho>().HasOne(x => x.Estado).WithMany().HasForeignKey(x => x.Estado_Id).OnDelete(deleteBehavior: DeleteBehavior.Restrict);

            //Detalles Planillas Despacho
            modelBuilder.Entity<Detalles_PlanillaDespacho>().HasOne(x => x.Cli).WithMany().HasForeignKey(x => x.Cli_Id).OnDelete(deleteBehavior: DeleteBehavior.Restrict);
            modelBuilder.Entity<Detalles_PlanillaDespacho>().HasOne(x => x.Planilla).WithMany().HasForeignKey(x => x.Pla_Id).OnDelete(deleteBehavior: DeleteBehavior.Restrict);

            //Trazabilidad Produccion
            modelBuilder.Entity<Trazabilidad_Produccion>().HasOne(x => x.ProductoAnt).WithMany().HasForeignKey(x => x.Prod_Anterior).OnDelete(deleteBehavior: DeleteBehavior.Restrict);
            modelBuilder.Entity<Trazabilidad_Produccion>().HasOne(x => x.Producto).WithMany().HasForeignKey(x => x.Prod_Id).OnDelete(deleteBehavior: DeleteBehavior.Restrict);
            modelBuilder.Entity<Trazabilidad_Produccion>().HasOne(x => x.ProcesoAnt).WithMany().HasForeignKey(x => x.Proceso_Anterior).OnDelete(deleteBehavior: DeleteBehavior.Restrict);
            modelBuilder.Entity<Trazabilidad_Produccion>().HasOne(x => x.Procesos).WithMany().HasForeignKey(x => x.Proceso_Id).OnDelete(deleteBehavior: DeleteBehavior.Restrict);
            modelBuilder.Entity<Trazabilidad_Produccion>().HasOne(x => x.Usuario1).WithMany().HasForeignKey(x => x.Operario_1).OnDelete(deleteBehavior: DeleteBehavior.Restrict);
            modelBuilder.Entity<Trazabilidad_Produccion>().HasOne(x => x.Usuario2).WithMany().HasForeignKey(x => x.Operario_2).OnDelete(deleteBehavior: DeleteBehavior.Restrict);
            modelBuilder.Entity<Trazabilidad_Produccion>().HasOne(x => x.Usuario3).WithMany().HasForeignKey(x => x.Operario_3).OnDelete(deleteBehavior: DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity<Trazabilidad_Produccion>().HasOne(x => x.Autoriza).WithMany().HasForeignKey(x => x.Autoriza_Id).OnDelete(deleteBehavior: DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity<Toma_Fisica_Inventario>().HasOne(x => x.Producto).WithMany().HasForeignKey(x => x.Prod_Id).OnDelete(deleteBehavior: DeleteBehavior.Restrict);
            modelBuilder.Entity<Toma_Fisica_Inventario>().HasOne(x => x.Clientes).WithMany().HasForeignKey(x => x.Cli_Id).OnDelete(deleteBehavior: DeleteBehavior.Restrict);
            modelBuilder.Entity<Toma_Fisica_Inventario>().HasOne(x => x.Unidad_Medida).WithMany().HasForeignKey(x => x.Presentacion).OnDelete(deleteBehavior: DeleteBehavior.Restrict);
